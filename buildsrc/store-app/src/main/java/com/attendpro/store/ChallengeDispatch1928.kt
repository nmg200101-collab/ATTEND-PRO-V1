...
object ChallengeDispatch1928 {
    fun send(activity: Context, employeeId: String, secret: ByteArray, method: AttendanceMethod, expiresAt: Long = System.currentTimeMillis() + 60_000L, requestToken: Int = java.security.SecureRandom().nextInt(), action: AttendanceAction = AttendanceAction.CHECK_IN): Boolean {
