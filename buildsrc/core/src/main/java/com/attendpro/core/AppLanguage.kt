...
object AppLanguage {
    ...
    fun legacyUiText(context: Context, value: String): String {
        ...
        return value
            .replace("إدارة صاحب العمل", "Employer Management")
            .replace("إدارة المحل", "Store Management")
            .replace("إدارة النظام", "System Administration")
            .replace("صاحب النظام", "System Owner")
            .replace("صاحب العمل", "Employer")
            .replace("هاتف الموظف", "Employee phone")
            .replace("هواتف الموظفين", "Employee phones")
            .replace("الموظفون", "Employees")
            .replace("الموظف", "Employee")
            .replace("المحل", "Store")
            .replace("الفرع", "Branch")
            .replace("الإصدار", "Version")
            .replace("رقم الطلب", "Request ID")
            .replace("معرف الجهاز", "Device ID")
            .replace("اسم المحل", "Store name")
            .replace("اسم صاحب المحل", "Store owner name")
            .replace("حالة التفعيل", "Activation status")
            .replace("حالة المحل", "Store status")
            .replace("حالة الاتصال", "Connection status")
            .replace("الحالة", "Status")
            .replace("الربط", "Pairing")
            .replace("التفعيل المركزي", "Central activation")
            .replace("التفعيل نشط", "activation active")
            .replace("الخادم المركزي", "Central server")
            .replace("الخادم", "Server")
            .replace("مهلة تشغيل", "operating lease")
            .replace("مزامنة الحضور", "attendance synchronization")
            .replace("التقارير", "Reports")
            .replace("الحضور", "Attendance")
            .replace("الانصراف", "Check-out")
            .replace("إثبات الوجود", "Presence proof")
            .replace("طريقة التحقق", "verification method")
            .replace("طرق التحقق", "verification methods")
            .replace("بصمة الهاتف", "phone biometric")
            .replace("بصمة الصوت", "voiceprint")
            .replace("بصمة الوجه", "face verification")
            .replace("كلمة المرور", "password")
            .replace("رمز شخصي", "PIN")
            .replace("جهاز بصمة", "fingerprint device")
            .replace("الموقع", "Location")
            .replace("دقة", "accuracy")
            .replace("المسافة", "distance")
            .replace("منذ", "ago")
            .replace("ثانية", "seconds")
            .replace("مراقبة فقط", "monitoring only")
            .replace("ليس إثبات حضور", "not attendance proof")
            .replace("تم التعرف عبر GPS", "Detected via GPS")
            .replace("جاري", "In progress:")
            .replace("تعذر", "Unable to")
            .replace("تم", "Completed:")
            .replace("يلزم", "Required:")
            .replace("يجب", "Must")
            .replace("مطلوب", "Required")
            .replace("غير صالح", "invalid")
            .replace("غير مكتمل", "incomplete")
            .replace("غير متصل", "not connected")
            .replace("موقوف", "suspended")
            .replace("منتهي", "expired")
            .replace("انتهت", "expired")
            .replace("بانتظار", "waiting for")
            .replace("اعتماد", "approval")
            .replace("موافقة", "approval")
            .replace("حفظ", "save")
            .replace("إرسال", "send")
            .replace("استعادة", "restore")
            .replace("تسجيل", "register")
            .replace("طلب", "request")
            .replace("تحديث", "update")
            .replace("فحص", "check")
            .replace("الاتصال", "connection")
            .replace("إعدادات", "settings")
            .replace("بيانات", "data")
            .replace("رقم", "number")
            .replace("نشط", "active")
            .replace("مرتبط", "linked")
            .replace("مفعّل", "enabled")
