...
checks = {
    ...
    "App lock": ("buildsrc/core/src/main/java/com/attendpro/core/AppLock.kt", "abstract class AppLockGateActivity"),
    ...
    "Subscriber recovery credential UI": ("buildsrc/store-app/src/main/java/com/attendpro/store/SystemManagement1971Activity.kt", "issueSubscriberRecovery"),
}
