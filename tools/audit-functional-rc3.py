...
checks = {
    ...
    "Face verification engine": ("buildsrc/store-app/src/main/java/com/attendpro/store/FaceSignatureEngine.kt", "object FaceSignatureEngine"),
    "Voice verification engine": ("buildsrc/store-app/src/main/java/com/attendpro/store/VoiceSignatureEngine.kt", "object VoiceSignatureEngine"),
